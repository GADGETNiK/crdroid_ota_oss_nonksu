...
path=/home/tux/crdroid10_oss                                                             # Here you will need to specify the path to the crDroid source code folder
...
zip=$(basename $path/out/target/product/$device/crDroidAndroid-14.0-*-$device-*-VANILLA.zip)        # Here we get the package name with the extension .zip
nozip=$(basename $path/out/target/product/$device/crDroidAndroid-14.0-*-$device-*-VANILLA.zip .zip) # Here we get the package name without the extension .zip
...
gapps="https://github.com/BiTGApps/BiTGApps-Release/releases/download/v2.7/BiTGApps-arm64-14.0.0-v2.7-CORE.zip" #https link (leave empty if unused)
